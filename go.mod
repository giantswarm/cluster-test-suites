...
require (
	...
	github.com/giantswarm/cluster-standup-teardown v1.25.3
	github.com/giantswarm/clustertest v1.27.0
	github.com/gravitational/teleport/api v0.0.0-20240928100213-82fb33db7680

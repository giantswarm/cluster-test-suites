...
require (
	...
	github.com/giantswarm/cluster-standup-teardown/v6 v6.0.2-0.20260716090449-8af1678dfdf3
	github.com/giantswarm/clustertest/v5 v5.4.1-0.20260716041347-a71c0f976a12

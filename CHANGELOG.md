...
- Migrate from CAPI v1beta1 to v1beta2 (`sigs.k8s.io/cluster-api` v1.12.3) and bump `clustertest` from v3 to v4.0.0.
- Bump `cluster-standup-teardown` from v4 to v5.0.0.
...
- Go: Update `cluster-standup-teardown` to v4.1.2.
...
- Use the `giantswarm-garm-wc-e2e` garm for WC e2e testing on `garm`
...
- Polling for node roll detection to fix race condition on single control plane node providers.

## [2.6.3] - 2025-12-16

### Changed

- Go: Update `cluster-standup-teardown` to v2.3.4. ([#880](https://github.com/giantswarm/cluster-test-suites/pull/880))
...
- Call LLM when `BeforeSuite` fails to provision a cluster to investigate what happened.
...
- Add LLM failure handler to investigate failures in tests.
...
- Update `clustertest` to v2.1.1 to fix tests for EKS clusters.

## [2.1.0] - 2025-10-16

### Changed

- Update `clustertest` to v2.1.0 to support EKS tests.
...
- Show `HelmReleases` status when testing cluster fails to get ready during the setup.
...
- Fix node roll detection test to properly handle boolean values.
...
- Skip standard upgrade test if no previous release is found in the same major version.
...
[Unreleased]: https://github.com/giantswarm/cluster-test-suites/compare/v5.0.0...HEAD
...
[2.4.2]: https://github.com/giantswarm/cluster-test-suites/compare/v2.4.1...v2.4.2
[2.4.1]: https://github.com/giantswarm/cluster-test-suites/compare/v2.4.0...v2.4.1
[2.4.0]: https://github.com/giantswarm/cluster-test-suites/compare/v2.3.0...v2.4.0
[2.3.0]: https://github.com/giantswarm/cluster-test-suites/compare/v2.2.0...v2.3.0
[2.2.0]: https://github.com/giantswarm/cluster-test-suites/compare/v2.1.1...v2.2.0
[2.1.1]: https://github.com/giantswarm/cluster-test-suites/compare/v2.1.0...v2.1.1
[2.1.0]: https://github.com/giantswarm/cluster-test-suites/compare/v2.0.2...v2.1.0
[2.0.2]: https://github.com/giantswarm/cluster-test-suites/compare/v2.0.1...v2.0.2
[2.0.1]: https://github.com/giantswarm/cluster-test-suites/compare/v2.0.0...v2.0.1
[2.0.0]: https://github.com/giantswarm/cluster-test-suites/compare/v1.99.0...v2.0.0
[1.99.0]: https://github.com/giantswarm/cluster-test-suites/compare/v1.98.0...v1.99.0
[1.98.0]: https://github.com/giantswarm/cluster-test-suites/compare/v1.97.1...v1.98.0
[1.97.1]: https://github.com/giantswarm/cluster-test-suites/compare/v1.97.0...v1.97.1
